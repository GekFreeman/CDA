...
import os
import math
import data_loader_sampler_2 as data_loader
import save_pred
import resnet_step2_cs_2 as models
            ...
            if ep<epoch_point:
              ...
              #  print(len(dic1))
               ...
               # tgt_data2, _ ,tgt_path2= tgt_data_iter2#.next()
                ...
                cls_loss,mmd_loss,pred_tgt1,pred_tgt2 = model(source_data1,source_label1, source_data2,source_label2,tgt_data1,tgt_data2,step = 2,alpha=alpha, label_tgt1=tgt_pse1, label_tgt2=tgt_pse2,target_data1=target_data1 ,target_data2=target_data2)
