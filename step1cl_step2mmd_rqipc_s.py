...
import math
import save_pred
import data_loader_path as data_loader
import resnet_step2_50 as models
...
output_dir="./tsnemodel_wommd"
"""
source1_name = "Clipart"
source2_name = "Product"
source3_name = "Real World"
target_name = "Art"
"""
##############
...
def train(model):
    ...
    #heapify(h)
    savepath='./heapq_target_rqipc.txt'
    time1=time.time()
        ...
        for batch_idx in range(len_source1):
           ...
           # print('the batch of:', batch_idx)
            ...
            try:
                ...
                source_data2, source_label2 = source1_iter2.next()
            try:
                target_data1, __ ,target_path1 = target_iter1.next()
                target_data2, __ ,target_path2 = target_iter2.next()
            except Exception as err:
                target_iter1 = iter(target_train_loader1)
                target_data1, __,target_path1 = target_iter1.next()
                target_iter2 = iter(target_train_loader2)
            ...
            if ep<2:
              ...
              #  print(model(source_data1,source_label1, source_data2,source_label2,target_data,step = 1,alpha=alpha))
                ...
                dic1=save_pred.save_target(dic1,pred_tgt1,target_path1)
                dic1=save_pred.save_target(dic1,pred_tgt2,target_path2)
              ...
              #  print(dic1)
                ...
                gamma = 2 / (1 + math.exp(-10 * (batch_idx) / (len_source1) )) - 1
              #  print(len(dic1))
                target_iter1,target_iter2=data_loader.load_sameclass_target(dic1,source_data1, source_label1, source_data2,source_label2,batch_size)
                ########################
                try:
                    target_data1, _,target_path1 = target_iter1.next()
                    target_data2,_,target_path2 = target_iter2.next()
                except Exception as err:
                    target_iter1 = iter(target_train_loader1)
                    target_data1, _,target_path1 = target_iter1.next()
                    target_iter2 = iter(target_train_loader2)
                    target_data2,_, target_path2 = target_iter2.next()
                if cuda:
               # print(source_label1)s
                    target_data1 = target_data1.cuda()
                    target_data2= target_data2.cuda()         
                target_data1 = Variable(target_data1)
                target_data2 = Variable(target_data2)
                tgt_data1,tgt_data2= target_data1,target_data2
          ...
          #  s_correct=test_source(model,1)
           # print("test time:",time3-time2)
            if t_correct > correct:
                correct = t_correct
                save_name = os.path.join(output_dir, 'cl_step2_mmd_gate_res50_source1_{}_{}_{}_{}_{}_to_{}_{}.pth'.format(source1_name, source2_name, source3_name,source4_name,source5_name,target_name,ep))
           ...
           # print('the batch of:', batch_idx)
            ...
            if ep<5:
              ...
              #  print(dic1)
                ...
                gamma = 2 / (1 + math.exp(-10 * (batch_idx) / (len_source1) )) - 1
              #  print(len(dic1))
                target_iter1,target_path1,target_iter2,target_path2=data_loader.load_sameclass_target(dic1,source_data1, source_label1, source_data2,source_label2,batch_size)
                ########################
                try:
                    target_data1, __ ,target_path1 = target_iter1.next()
                    target_data2, __ ,target_path2 = target_iter2.next()
